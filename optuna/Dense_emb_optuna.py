...
def objective(trial):
    ...
    pool_type = trial.suggest_categorical("pool_type", ["flatten", "average", "attention"])
    ...
    cmd = [
        "python", "Dense_emb_imputation.py", "train-and-eval",
